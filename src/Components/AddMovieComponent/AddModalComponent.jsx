...
const AddModalComponent = () => {
  ...
  const res = axios.post(`${BASE_URL}/movie`, movie,{headers :{Authorization : token}});
  ...
  return (
    ...
    <Form.Label>Select a type</Form.Label>
      <Form.Select name='type' onChange={inputEvents} aria-label="Select type">
  ...
  <Form.Group className="mb-3" controlId="formBasicEmail">
    ...
    <Form.Control onChange={inputEvents} name='title' type="text" placeholder="Enter movie title (movie name)" />
  </Form.Group>

  <Form.Group className="mb-3" controlId="formBasicEmail">
    <Form.Label>Director's name</Form.Label>
    <Form.Control onChange={inputEvents}  name='director' type="text" placeholder="Enter director's name" />
  </Form.Group>

  <Form.Group className="mb-3" controlId="formBasicEmail">
    <Form.Label>Cast</Form.Label>
    <Form.Control onChange={inputEvents}  name='cast' type="text" placeholder="Enter cast name in comma seprated eg.(john, mike)" />
  </Form.Group>
  <Form.Group className="mb-3" controlId="formBasicEmail">
    <Form.Label>Release Country</Form.Label>
    <CountrySelector onChange={inputEvents} country={movie.country} setCountry={setCountry} name="country" /> 
  </Form.Group>
  {/* Date added -- Todays date do it using java. */}

  <Form.Group className="mb-3" controlId="formBasicEmail">
    <Form.Label>Release Year</Form.Label>
    <Form.Control onChange={inputEvents} name='releaseYear' type="number" placeholder="Enter a year" />
  </Form.Group>

  <Form.Group className="mb-3" controlId="formBasicEmail">
    <Form.Label>Rating</Form.Label>
    <Form.Select onChange={inputEvents} name='rating' aria-label="Select rating">
  ...
  <Form.Group className="mb-3" controlId="formBasicEmail">
    ...
    <Form.Control type="text" onChange={inputEvents} name='duration' placeholder="Enter Duration eg. (120 Minutes, 7 Seasons)" />
  </Form.Group>

  <Form.Group className="mb-3" controlId="formBasicEmail">
    <Form.Label>Listed in / Genre</Form.Label>
    <Form.Control type="text" onChange={inputEvents} name='listedIn' placeholder="Enter Genre" />
  </Form.Group>

  <Form.Group className="mb-3" controlId="formBasicEmail">
    <Form.Label>Description</Form.Label>
    <FormControl onChange={inputEvents} name='description' as="textarea" rows={3} placeholder="Enter movie's description" />
  </Form.Group>
